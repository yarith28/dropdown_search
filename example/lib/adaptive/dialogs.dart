...
class AdaptiveDialogExamplesPage extends StatefulWidget {
  @override
  State<AdaptiveDialogExamplesPage> createState() => _AdaptiveDialogExamplesPageState();
}

class _AdaptiveDialogExamplesPageState extends State<AdaptiveDialogExamplesPage> {
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              AdaptiveDropdownSearch<MultiLevelString>(
                ...
                popupProps: AdaptivePopupProps(materialProps: PopupProps.dialog(
                  showSelectedItems: true,
...
class _DropdownWithGlobalCheckBoxState extends State<DropdownWithGlobalCheckBox> {
  ...
  Widget build(BuildContext context) {
    return AdaptiveDropdownSearch<int>.multiSelection(
      ...
      popupProps: AdaptiveMultiSelectionPopupProps(materialProps: MultiSelectionPopupProps.dialog(
